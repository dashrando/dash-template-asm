...
; Init
;--------------------------------------------------------------------------------
org $808490 : JMP.w InitRAM ; Jump because we're overwriting the stack
...
;------------------------------------------------------------------------------
org $828067 : JSL.l InitGameState
...
; New Items
;------------------------------------------------------------------------------
org $8488F9 : JSR.w VanillaEquipmentPickup

; Suits
org $90E74D : JSR.w ApplyPeriodicDamage
org $9081F7 : JMP.w LavaDamage
org $908239 : JMP.w AcidDamage
org $8DE379 : JML.l HeatDamage : NOP #2
...
; Double Jump
org $90A46E : JSR.w CheckEligibleJump : NOP #3
...
org $90B8EC : JSR.w UpdateUnchargedDamage

org $8488C9 : JSR.w MaybeEquipSpazer
...
org $82B4E9 : LDA.w #$C056 : JSR.w CheckEquipmentBitmask
org $82B514 : LDA.w #$C062 : JSR.w CheckEquipmentBitmask
org $82B542 : LDA.w #$C062 : JSR.w CheckEquipmentBitmask

org $82AFD3 : JSR.w SetHUDFlagMenu
org $82B0CD : JSR.w SetHUDFlagMenu
org $82B15B : JSR.w SetHUDFlagMenu

;------------------------------------------------------------------------------
; Credits
;------------------------------------------------------------------------------
org $8B9971 : PEA.w CreditsScript>>8
org $8B9976 : JML.l ScrollCredits
org $8BF6FC : dw CreditsScript

; Hijack after decompression of regular credits tilemaps
org $8BE0D1 : JSL.l CopyCreditsTileMap

; Add DASH items to final collection rate
org $8BE65B : JSR.w CountDashItems

; Post-credits Samus
org $8BE00A : LDA.w RTASeconds : CMP.w #$0A8B
org $8BE1E0 : LDA.w RTASeconds : CMP.w #$0A8B : skip 2 : CMP.w #$0E10
org $8BE276 : LDA.w RTASeconds : CMP.w #$0A8B
org $8BE2E4 : LDA.w RTASeconds : CMP.w #$0A8B : skip 2 : CMP.w #$0E10
org $8BE325 : LDA.w RTASeconds : CMP.w #$0A8B
org $8BE36C : LDA.w RTASeconds : CMP.w #$0A8B : skip 2 : CMP.w #$0E10
org $8BF555 : LDA.w RTASeconds : CMP.w #$0E10
org $8BF597 : LDA.w RTASeconds : CMP.w #$0E10
org $8BF5BA : LDA.w RTASeconds : CMP.w #$0E10

;------------------------------------------------------------------------------
; Subareas
;------------------------------------------------------------------------------
org $82DE86 : JSR.w OnRoomLoad

;------------------------------------------------------------------------------
; Stats
;------------------------------------------------------------------------------
org $809602 : JSR.w IncrementLagTimer

org $82E309 : JMP.w DoorAdjustStart
org $82E34C : JMP.w DoorAdjustStop
org $82E176 : JMP.w IncrementDoorTransitions
org $90B9A1 : JSR.w IncrementChargedShots
org $90CCDE : JSR.w IncrementSpecialBeams
org $90BEB7 : JMP.w IncrementMissiles
org $90C107 : JSR.w IncrementBombs

org $A2AB13 : JSL.l OnCompleteGoal

;------------------------------------------------------------------------------
; Saves
;------------------------------------------------------------------------------
; Loading save after file selection, transition to game options screen.
org $81A24A : JSR.w LoadSaveExpanded : BRA FileSelect_Done
org $81916C : JSR.w LoadSaveExpanded : NOP

org $818006 : JSL.l OnWriteSave : NOP

org $819AEE : JSR.w CopyExtendedBuffers
org $819D1A : JSR.w ClearExtendedSRAM
...
org $809BFB : JSR.w DrawNewHUD

; Max ammo tile changes
org $858851 : db $0F,$28,$0F,$28,$0F,$28
org $858891 : db $49,$30,$4A,$30,$4B,$30
org $858951 : db $0F,$28,$0F,$28,$0F,$28
org $858993 : db $34,$30,$35,$30
org $858A4F : db $0F,$28,$0F,$28
org $858A8f : db $36,$30,$37,$30

; Item counts
org $848983 : JMP.w DecrementTankCount
;org $8489A6 : JMP.w DecrementTankCount
org $8488F0 : JMP.w DecrementMajorCountHUDBeam
org $84893E : JMP.w DecrementMajorCountHUDBeam
org $848965 : JMP.w DecrementMajorCountHUDBeam
...
; Message Boxes
;------------------------------------------------------------------------------
org $858243 : JSR.w fix_1c1f
org $8582E5 : JSR.w fix_1c1f

org $858086 : JSR.w SetMessageBoxFlag
org $8580B7 : JSR.w UnsetMessageBoxFlag

org $858413 : dw BtnArray

org $858490 : JSR.w MessageBoxTimer
org $8488DE : JSR.w HandleRoomMusicPickup : NOP #4
org $848905 : JSR.w HandleRoomMusicPickup : NOP #4
org $848930 : JSR.w HandleRoomMusicPickup : NOP #4
org $848957 : JSR.w HandleRoomMusicPickup : NOP #4
org $848975 : JSR.w HandleRoomMusicPickup : NOP #4
org $848998 : JSR.w HandleRoomMusicPickup : NOP #4
org $8489C1 : JSR.w HandleRoomMusicPickup : NOP #4
org $8489EA : JSR.w HandleRoomMusicPickup : NOP #4
org $848A13 : JSR.w HandleRoomMusicPickup : NOP #4
org $8488DE : JSR.w HandleRoomMusicPickup : NOP #4

;------------------------------------------------------------------------------
; Setup DASH Logo
;------------------------------------------------------------------------------
org $8B9CAF : JSL.l LoadTitleLogo
...
org $8882C4 : JSL.l FixRidleyQuake : BRA + : NOP #3 : +

;------------------------------------------------------------------------------
; Door Transitions
;------------------------------------------------------------------------------
org $9493A7 : JSR.w HandleEnterDoor : NOP
org $9493EA : JSR.w HandleEnterDoor : NOP
...
; Flashing Doors
;------------------------------------------------------------------------------
org $84BE43 : LDA.w CustomGreyDoorList,y
